...
import com.wanted.crud.global.config.wanted_JDBCTemplate;

import java.sql.Connection;
import java.sql.SQLException;

public class wanted_Application {

    public static void main(String[] args) {

        try (Connection con = wanted_JDBCTemplate.getConnection()) {

            System.out.println("✅ 데이터베이스 연결 성공!!!");
            wanted_JDBCTemplate.printConnectionStatus();
