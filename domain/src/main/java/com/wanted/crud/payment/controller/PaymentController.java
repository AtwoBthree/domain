...
public class PaymentController {
    ...
    public Long createPayment(Long paymentAmount, String paymentMethod, Long studentId, Long courseId) {


        /* comment.
         *   타이틀과 설명은 논리적으로 묶여야 하는 데이터이다.
         *   authorId 는 나중에 로그인을 한 유저 객체에서 추출해서 넣어주어야 한다.*/
        PaymentDTO newPayment = new PaymentDTO(paymentAmount, paymentMethod, studentId, courseId);
